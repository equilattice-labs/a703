...
<div class="shell">
  ...
  <header class="top">
    <button class="logo" aria-label="Partivio home" @click="go('home')"><span aria-hidden="true">&#10022;</span> PARTIVIO</button>
  ...
  <footer><span>&#10022; PARTIVIO</span><span>Independent community project on Robinhood Chain Testnet</span><span>Testnet DLU / No promised financial return</span></footer>
