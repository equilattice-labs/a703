...
const source = readFileSync(new URL('../src/usePactelora.js', import.meta.url), 'utf8')
  .replace(/^\uFEFF/, '')
  .replace(/^import .*\r?\n/gm, '')
  .replace('export function usePactelora()', 'function usePactelora()')
